Ext.define('Base.view.calendar.CalendarForm', {
	...
	items : [
		...
		{ name : 'description', fieldLabel : T('label.description'), maxLength : 255 },
		{
			...
			items: [
				{ xtype: 'label', text : T('label.day1')},
				{ xtype: 'label', text : T('label.day2')},
				{ xtype: 'label', text : T('label.day3')},
				{ xtype: 'label', text : T('label.day4')},
				{ xtype: 'label', text : T('label.day5')},
				{ xtype: 'label', text : T('label.day6')},
				{ xtype: 'label', text : T('label.day7')}
			]
		},
		{
			xtype: 'checkboxgroup',
